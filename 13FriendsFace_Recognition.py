...
known_faces = {
    "Po": load_and_encode_face('Family/known/Po.jpeg'),
    "Parth": load_and_encode_face('Family/known/Parth.jpeg'),
    "Rohan": load_and_encode_face('Family/known/Rohan.jpeg'),
    "Toral": load_and_encode_face('Family/known/Toral.jpeg'),
    "Meet": load_and_encode_face('Family/known/Meet.jpeg'),
}
...
while True:
    ...
    for face_location, face_encoding in zip(face_locations, face_encodings):
        ...
        if face_name == "Unknown Person":
            break
        cv2.putText(frame, "hey {} whats up!, abhi talks about you a lot!".format(face_name), (50, 50), font, .75, (255, 0, 0), 2)
        if face_name == "Po":
            cv2.putText(frame, "I have heard that you excersice a lot? we you teach me how to do that?".format(face_name), (50, 700), font, .75, (0, 255, 0), 2)
        if face_name == "Meet":
            cv2.putText(frame, "I have heard that you know lot about cars? we you teach me that".format(face_name), (50, 700), font, .75, (0, 255, 0), 2)
        if face_name == "Rohan":
            cv2.putText(frame, "I have heard that you are very good at doubts! we you teach me that?".format(face_name), (50, 700), font, .75, (0, 255, 0), 2)
        if face_name == "Parth":
            cv2.putText(frame, "I have heard that you are very good at CNC Machining! we you teach me that?".format(face_name), (50, 700), font, .75, (0, 255, 0), 2)
        if face_name == "Toral":
            cv2.putText(frame, "I have heard that you know many language! we you teach me that?".format(face_name), (50, 700), font, .75, (0, 255, 0), 2)
